...
import webapp2
from recognition import Recognize, RecognizeBase64, RecognizeAndRecommend, RecTest, RecognizeAndRecommendBinary
...
app = webapp2.WSGIApplication([
    ...
    ('/recognize_and_recommend_binary', RecognizeAndRecommendBinary),
    ('/rec_test', RecTest),
